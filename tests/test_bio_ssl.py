...
class HandshakeClient(threading.Thread):
    ...
    def run(self):
        ...
        try:
            ...
            self.conn = SSL.Connection(ctx)
            sslbio = BIO.SSLBio()
            readbio = BIO.MemoryBuffer()
            writebio = BIO.MemoryBuffer()
            sslbio.set_ssl(self.conn)
            self.conn.set_bio(readbio, writebio)
            ...
            while not handshake_complete:
                ...
                if ret > 0:
                    ...
                    return
                elif not output_token and sslbio.should_read():
        ...
        try:
            ...
            try:
                while not handshake_complete:
                    ...
                    elif not output_token and self.sslbio.should_read():
