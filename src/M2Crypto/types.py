...
ASN1_UTCTime = NewType("ASN1_UTCTime", object)
...
OSSL_LIB_CTX = NewType("OSSL_LIB_CTX", object)
OSSL_PROVIDER = NewType("OSSL_PROVIDER", object)
...
STACK_OF_X509_CRL = NewType("STACK_OF_X509_CRL", object)
