...
# ASN.1 string flags
ASN1_STRFLGS_ESC_2253: int
ASN1_STRFLGS_ESC_CTRL: int
ASN1_STRFLGS_ESC_MSB: int
ASN1_STRFLGS_ESC_QUOTE: int
ASN1_STRFLGS_UTF8_CONVERT: int
ASN1_STRFLGS_IGNORE_TYPE: int
ASN1_STRFLGS_SHOW_TYPE: int
ASN1_STRFLGS_DUMP_ALL: int
ASN1_STRFLGS_DUMP_UNKNOWN: int
ASN1_STRFLGS_DUMP_DER: int
ASN1_STRFLGS_RFC2253: int
...
def asn1_time_type_check(a: Union[C.ASN1_Time, C.ASN1_UTCTime]) -> int: ...
def asn1_object_free(a: C.ASN1_Object) -> None: ...
def asn1_object_new() -> C.ASN1_Object: ...
def asn1_object_create(
    tag: int, data: bytes, length: int, sn: str, ln: str
) -> C.ASN1_Object: ...
def i2d_asn1_object(a: C.ASN1_Object) -> bytes: ...
def d2i_asn1_object(data: bytes) -> C.ASN1_Object: ...
def asn1_bit_string_new() -> C.ASN1_BitString: ...
def asn1_time_check(a: C.ASN1_Time) -> int: ...
def asn1_utctime_new() -> C.ASN1_UTCTime: ...
def asn1_utctime_free(a: C.ASN1_UTCTime) -> None: ...
def asn1_utctime_check(a: C.ASN1_UTCTime) -> int: ...
def asn1_utctime_set(a: C.ASN1_UTCTime, t: int) -> C.ASN1_UTCTime: ...
def asn1_utctime_set_string(a: C.ASN1_UTCTime, s: str) -> int: ...
def asn1_utctime_print(bio: C.BIO, s: C.ASN1_UTCTime) -> int: ...
...
def bn_to_hex(bn: C.BIGNUM) -> bytes: ...
def hex_to_bn(s: Union[bytes, bytearray, memoryview]) -> C.BIGNUM: ...
def dec_to_bn(s: Union[bytes, bytearray, memoryview]) -> C.BIGNUM: ...
...
def cipher_update_aad(ctx: C.EVP_CIPHER_CTX, data: bytes) -> None: ...
def cipher_ctrl_set(ctx: C.EVP_CIPHER_CTX, cmd: int, arg: Any) -> int: ...
def cipher_ctrl_get(ctx: C.EVP_CIPHER_CTX, cmd: int, outlen: int) -> bytes: ...
...
def ssl_ctx_set_tls1(ctx: C.SSL_CTX) -> int: ...
...
def sk_x509_crl_free(stack: C.STACK_OF_X509_CRL) -> None: ...
def sk_x509_crl_new_null() -> C.STACK_OF_X509_CRL: ...
def sk_x509_crl_num(stack: C.STACK_OF_X509_CRL) -> int: ...
def sk_x509_crl_pop(stack: C.STACK_OF_X509_CRL) -> Optional[C.X509_CRL]: ...
def sk_x509_crl_push(stack: C.STACK_OF_X509_CRL, crl: C.X509_CRL) -> int: ...
def sk_x509_crl_value(stack: C.STACK_OF_X509_CRL, idx: int) -> C.X509_CRL: ...
...
def x509_store_ctx_new() -> C.X509_STORE_CTX: ...
...
def x509v3_authority_key_identifier(keyid: bytes) -> C.X509_EXTENSION: ...
...
def pkcs7_create_degenerate(certs: C.STACK_OF_X509, flags: int) -> int: ...
def pkcs7_get_certs_sk(p7: C.PKCS7) -> Optional[C.STACK_OF_X509]: ...
...
# --- Engine ---
ENGINE_METHOD_CIPHERS: int
ENGINE_METHOD_DH: int
ENGINE_METHOD_DIGESTS: int
ENGINE_METHOD_DSA: int
ENGINE_METHOD_ECDH: int
ENGINE_METHOD_ECDSA: int
ENGINE_METHOD_NONE: int
ENGINE_METHOD_RAND: int
...
def engine_ctrl_cmd_string(
    e: C.ENGINE, cmd_name: str, arg: Optional[str], cmd_optional: int
) -> int: ...
def engine_finish(engine: C.ENGINE) -> int: ...
def engine_free(engine: C.ENGINE) -> int: ...
def engine_get_id(engine: C.ENGINE) -> str: ...
def engine_get_name(engine: C.ENGINE) -> str: ...
def engine_init(engine: C.ENGINE) -> int: ...
def engine_init_error(engine_err: Any) -> None: ...
def engine_load_builtin_engines() -> None: ...
def engine_load_certificate(engine: C.ENGINE, slot: str) -> Optional[C.X509]: ...
def engine_load_dynamic() -> None: ...
def engine_load_openssl() -> None: ...
def engine_load_private_key(
    engine: C.ENGINE, key_id: str, ui_method: Any, callback_data: Any
) -> Optional[C.EVP_PKEY]: ...
def engine_load_public_key(
    engine: C.ENGINE, key_id: str, ui_method: Any, callback_data: Any
) -> Optional[C.EVP_PKEY]: ...
def engine_new() -> Optional[C.ENGINE]: ...
def engine_pkcs11_data_free(vcb: Any) -> None: ...
def engine_pkcs11_data_new(pin: Optional[str]) -> Any: ...
def engine_set_default(engine: C.ENGINE, flags: int) -> int: ...
def ui_openssl() -> Any: ...

# --- Provider ---
def provider_init_error(provider_err: Type[BaseException]) -> None: ...
def provider_context_new() -> Optional[C.OSSL_LIB_CTX]: ...
def provider_context_free(libctx: C.OSSL_LIB_CTX) -> None: ...
def provider_load(libctx: C.OSSL_LIB_CTX, name: str) -> Optional[C.OSSL_PROVIDER]: ...
def provider_load_key(libctx: C.OSSL_LIB_CTX, uri: str) -> Optional[C.EVP_PKEY]: ...
def provider_load_certificate(libctx: C.OSSL_LIB_CTX, uri: str) -> Optional[C.X509]: ...
def provider_unload(provider: C.OSSL_PROVIDER) -> None: ...
def provider_generate_rsa_key_pair(
    bits: int,
    exponent: int,
    libctx: C.OSSL_LIB_CTX,
    provider: Optional[C.OSSL_PROVIDER],
) -> Optional[C.EVP_PKEY]: ...
def provider_generate_ec_key_pair(
    curve_name: str,
    libctx: C.OSSL_LIB_CTX,
    provider: Optional[C.OSSL_PROVIDER],
) -> Optional[C.EVP_PKEY]: ...
def provider_destroy_key(uri: str, user_pin: Optional[str]) -> int: ...
