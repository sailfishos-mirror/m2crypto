...
[M2Crypto](https://codefloe.com/mcepl/m2crypto) is a [Python](http://www.python.org) interface to [OpenSSL](http://www.openssl.org). It makes available to the Python
...
ZSmime is a [Zope](http://www.zope.org) *product* that enables Zope
...
ZSmime has its own
[HOWTO](http://sandbox.rulemaker.net/ngps/zope/zsmime/howto.html)
