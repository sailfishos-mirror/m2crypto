...
class RSATestCase(unittest.TestCase):
    ...
    data = hashlib.sha256(b"The magic words are squeamish ossifrage.").digest()
    ...
    def test_loadkey_pp(self):
        ...
        self.assertEqual(rsa.e, b"\000\000\000\003\001\000\001")  # aka 65537 aka 0xf4
    ...
    def test_loadkey(self):
        ...
        self.assertEqual(
            rsa.n,
            b'\x00\x00\x01\x01\x00\xb9\xfe\xeff."'
            + b'\xe9^q\xdb\xad\x0c\x06l\xbf\x80\x1a\xb6'
            + b'\xa6\xeeD\xf7/h\xb6\xd5r%k\xd5\xcb\xed\xe3'
            + b'\x1c\x1a\x89\x02^@\'\xbe\x9d\xadE\x06)=\x12'
            + b'{\xad\x98H\xa5\xd8\xc3\x0b\xa5\xb1\xcf#\xd60'
            + b'\x87\xbd\x01\xefA\x10\x9aQ\xe5e\xed\x9c\xdcC'
            + b'\tg/\xb7~\xe0\x143\x89\xe5\xb9\x9d\\i\xf6zQd'
            + b'\x91b#\xb0\x8bN\xd3\x00ZDg\xad?:\xde\x8e\xd8'
            + b'\xed\x13J\x88\xdefQ\xdc\x02\xda\xb8\xf1/\xcc'
            + b'\xf0\x81R\x94\xbd{\xaa4\xde\x1d\xfegJBeN1\xa4'
            + b'\x84\xe1\x7f\'\x1fy\xe2\tu]\xfaDv\xc7\x83\x96'
            + b'\xb4\xd5U\xd3\xc1\xca\xa4a/\xb8\x0c\xa8\xc3\xe6'
            + b'\x04t%$\xab\xa1\x85H\xa0\xcf\x18\xc4\x89\xf62\x90'
            + b'\x8b\x81\xc1\nR\xa6A\xe3\xaa\xe0\xc3\\\xd38\xb4O'
            + b'\xb0\x94\x8e7\x99\xa6\x1b\xe0\xac\x01\xed\'e\n'
            + b'\xb0\xd0\x8e\x16\t\xbe\xe8|c\xe2\xd9=\xdd\xc8O+i'
            + b'\xf9\x97\xc7\x84\x03\x1c\x87\x1f/\xaa\xc4\xf8'
            + b'\xcbdV\xb5\x1a\xd2\xf2A',
        )
        with self.assertRaises(AttributeError):
            getattr(rsa, "nosuchprop")
        out = rsa.check_key()
        log.debug(f'observed:\n{out}')
