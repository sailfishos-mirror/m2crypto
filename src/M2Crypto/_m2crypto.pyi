...
def provider_generate_rsa_key_pair(bits: int, exponent: int, provider: C.OSSL_PROVIDER) -> Optional[C.EVP_PKEY]: ...
def provider_generate_ec_key_pair(curve_name: str, provider: C.OSSL_PROVIDER) -> Optional[C.EVP_PKEY]: ...
