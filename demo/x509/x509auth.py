...
class CertHandler:
    ...
    def __init__(self):
        ...
        self.Params = {
            ...
            "Issuer": {
                ...
                "localityName": "tampas",
                "organizationName": "watersprings",
                "organizationalUnitName": "security",
                "commonName": "Certificate Authority",
                "emailAddress": "admin@security",
            },
            "Subject": {
                "countryName": "US",
                "stateOrProvinceName": "florida",
        ...
        self.KeyEnv = {
            "RsaPubKey": ["-----BEGIN PUBLIC KEY-----", "-----END PUBLIC KEY-----"],
            "RsaPKey": [
    ...
    def CertContainer(self):
        self.PemMap = {
            "CA": {
                ...
                "RsaPKey": [
                    "MIICXQIBAAKBgQDmAl+4+XdF34D3kBN58An29mA8/D+NUHVJW+XeE96uDJ9mw8f1",
                    "xguVYgfpMaiVihW/qDWZRu/NhWOfheKBVNstx5OcqIjY10vBvGAG17CQZhcon8eN",
                    "Kufg7XzON7e5WXXD8qyklhuesHtTEGGpZ1FfA+n+D/0JF3YfTBDeYyY2VQIDAQAB",
                    "AoGBAI53L/Uxx7fmzUoJ2pZvoKxwRIHhuDd+e3c5zbJ1WjsyJFWRtLw9tBUOCFpf",
                    "YM1nHzt8I97RulzxXxiC5B45ghu3S0s+B06oEOUxNLbjsai08DKBRFqM+IZIx11r",
                    "IM/tZsTdJg1KtKojRu63NDtOzR6a7ggTeMge5CDKpXVWpvVtAkEA+QF/q2NnsdmL",
                    "ak6ALl8QwMbvwujJcjLwvecHQJmB0jO9KF60Hh4VY8mTRIMZ/r9Wf+REsQcZtmhG",
                    "WRr12si5qwJBAOx4R0Wd/inoXOpvKheIoKgTg01FnLhT8uiLY59CuZRr6AcTELjC",
                    "Kvk6LyfhspYBkUwWAEwKxJ3kMeqXG+k8z/8CQQCy+GDKzqe5LKMHxWRb7/galuG9",
                    "NZOUgQiHdYXA6JRmgMl0Op07CGRXVIqEs7X7Y4rIYUj99ByG/muRn88VcTABAkBQ",
                    "Z6V0WoBtp4DQhfP+BIr8G4Zt49miI4lY4OyC3qFTgk1m+miZKgyKqeoW2Xtr3iSV",
                    "hnWbZZ3tQgZnCfKHoBHpAkAmf2OvfhLxaW1PwdjBdm9tFGVbzkLFDqdqww2aHRUx",
                    "sXonHyVG2EDm37qW7nzmAqUgQCueMhHREZQYceDrtLLO",
                ],
                "X509Cert": [
                    "MIICpzCCAhCgAwIBAQIBATANBgkqhkiG9w0BAQUFADCBmTERMA8GA1UECxMIc2Vj",
                    "dXJpdHkxFTATBgNVBAoTDHdhdGVyc3ByaW5nczEeMBwGA1UEAxMVQ2VydGlmaWNh",
                    "dGUgQXV0aG9yaXR5MRAwDgYDVQQIEwdmbG9yaWRhMQswCQYDVQQGEwJVUzEdMBsG",
                    "CSqGSIb3DQEJARYOYWRtaW5Ac2VjdXJpdHkxDzANBgNVBAcTBnRhbXBhczAeFw0w",
                    "MzAzMzExMDQ2MDVaFw0wOTAzMjkxMDQ2MDVaMIGYMREwDwYDVQQLEwhzZWN1cml0",
                    "eTEVMBMGA1UEChMMd2F0ZXJzcHJpbmdzMR4wHAYDVQQDExVDZXJ0aWZpY2F0ZSBB",
                    "dXRob3JpdHkxEDAOBgNVBAgTB2Zsb3JpZGExCzAJBgNVBAYTAlVTMR0wGwYJKoZI",
                    "hvcNAQkBFg5hZG1pbkBzZWN1cml0eTEOMAwGA1UEBxMFbWlhbWkwgZ8wDQYJKoZI",
                    "hvcNAQEBBQADgY0AMIGJAoGBAOYCX7j5d0XfgPeQE3nwCfb2YDz8P41QdUlb5d4T",
                    "3q4Mn2bDx/XGC5ViB+kxqJWKFb+oNZlG782FY5+F4oFU2y3Hk5yoiNjXS8G8YAbX",
                    "sJBmFyifx40q5+DtfM43t7lZdcPyrKSWG56we1MQYalnUV8D6f4P/QkXdh9MEN5j",
                    "JjZVAgMBAAEwDQYJKoZIhvcNAQEFBQADgYEAK7f4YodUnT7Ygp7BWBBDHSq/r+tY",
                    "H69ly3W23U5VupaIglNiNQoMqnZpVVfcuIYltajrux5TSH4gPbenCg163Ua8RvF6",
                    "E2JElccprbKiCf9tf8l6Rxpsall4EF+CazP56DiUD1NfGLhWp9V2ga9SoynEo1P1",
                    "eztMBfk01atBJ/s=",
                ],
            },
            "AuthInstance": {
                "Subject": {
                    "commonName": "AuthInstance",
                    "organizationalUnitName": "security",
                    "emailAddress": "ioclient@AuthInstance",
                },
                "RsaPKey": [
                    "MIICXQIBAAKBgQCwfB6CoOQTJTd6D4ua1G/H9hwqpdVUMMjG3O8Y93vYGesZdwtT",
                    "1iEQX/6TWACBxa7jOC8hHUHe2lsPu7imHv8dDiD59Rzets7BM88HsJTemYrxSv5G",
                    "uh8FloB1KEtSHeCZSlDT/tzSX4M0JfVPmtx+0FsyDOVZ6jXjRIyIKgqDlwIDAQAB",
                    "AoGAYc8YFatXW6j3mwU8iL2NidPC/nvTxAoZa+UL+dlG4JhUrFNGitsUjf+1ljFi",
                    "bomBiFod/Is7c2euqgSOrDpnheYlogv2QpnP80YUpiv9OruaB9I1zqJ7QM7PrkrH",
                    "m1C36DzyzVY+4DMvTV29do4Mf6CKT8xf6hXlLK/NbqwO9NkCQQDYwxwCTWxrkX08",
                    "+0c5KaTYxfqCByxOqoiKl97p6wHxNtlzdLeFoSZD0n3Q1c2v0DIXhcBPRPPaZBWC",
                    "yTayMkRzAkEA0G6I5mHQVNIx18Xmc75urC0QWrum9cj5VcyRvl3KCzB2kQoXkx6v",
                    "y0JN6YS37rSp8vmvIFNO/oHWSuEJlFYfTQJAajWv07D8Hvj61JaLH4c4Lr9TL8M0",
                    "Apesr7wajaOJIBgwFFJsWh3MEg9hdqJMVok9AimXQUAX/DpuD9dn5Yib4QJBAIdt",
                    "Kno2V7ylDkmahk/yDcrFRPkPMD5GpOrAjnnYSqzWglNe8U5gA+zXWfQ+jZwFut7q",
                    "qIUiXBM1nVzttuGwy4kCQQC3MHppypSWoFqd+TaxK3MX/HoZqaoRELXdeiniOt3Z",
                    "gFMJ4m6D9lL4segWDoDpequjDYxv2cl+wS1+qDOyeG3J",
                ],
                "X509Cert": [
                    "MIIBxDCCAS2gAwIBAQIBATANBgkqhkiG9w0BAQUFADAAMB4XDTAzMDMzMTEwNTE1",
                    "N1oXDTA5MDMyOTEwNTE1N1owUDEkMCIGCSqGSIb3DQEJARYVaW9jbGllbnRAQXV0",
                    "aEluc3RhbmNlMREwDwYDVQQLEwhzZWN1cml0eTEVMBMGA1UEAxMMQXV0aEluc3Rh",
                    "bmNlMIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCwfB6CoOQTJTd6D4ua1G/H",
                    "9hwqpdVUMMjG3O8Y93vYGesZdwtT1iEQX/6TWACBxa7jOC8hHUHe2lsPu7imHv8d",
                    "DiD59Rzets7BM88HsJTemYrxSv5Guh8FloB1KEtSHeCZSlDT/tzSX4M0JfVPmtx+",
                    "0FsyDOVZ6jXjRIyIKgqDlwIDAQABMA0GCSqGSIb3DQEBBQUAA4GBAFsXewlXnKpH",
                    "uSwxavmLPUqRk7o1D5E3ByTddBe3BY5NqEXk7Y2SJFtumiuUY5/sWB/aO8Xbqj/b",
                    "/7Cwg9+bc9QqxeeIe/YvtFOmv1ELh2BC1Nof7zSa5rLa/+gPYCoogS4mLRMuUfRk",
                    "tVHhpoxL1B+UXp4jNeKeTgquOjpUiyBR",
                ],
            },
            "192.168.1.20": {
                "Subject": {
                    "commonName": "192.168.1.20",
                    "organizationalUnitName": "security",
                    "emailAddress": "ioclient@192.168.1.20",
                },
                "RsaPKey": [
                    "MIICWwIBAAKBgQDD285BGY+FHhfpRvcqupN8X2lPwUNq4G7k5kit5cyuQLfN0+eQ",
                    "I+VFZdtfJhCZC54dEIvNgA4I7563pRUD0S9rmN6kh/M0GgrKZjYNO+CvvG2dts26",
                    "MGK0eUQaSsvDf9phEA+0mSv9dsUrdyBTJBn4mXvApekYHt+mNLfCVLkM1QIDAQAB",
                    "AoGAMqcFB3cJ0/59Zpowz/8ip3axcKvluJ1EcLRRtY+JyML6BiQ4beGqqLD38/qP",
                    "LlV/1bpyvXnRp2P5IztxXORbo77IzDVzl62YesQATnecSCMLTaeOusy2EZZsjE0k",
                    "V2cR1rZvzyJPY+Fi8X54hiB+5IcKkPRX9LVw7+yBbBh4sKECQQD0Yi0/DGa3IetR",
                    "9F+/jgN/VIcTd5KwMBW3Bw/+Bh78ZlZGaucpRiR1IQuD7sLTnhNS6RMJUxv10jnS",
                    "BGW9pjX5AkEAzSslOGFyJ5Aoy48rgC2kKwq6nFKJ/PmY92cnm0nqmwb2npbOtDxz",
                    "sPUdb7oYmUU/nVCJh3yb+KJIw2g9XxnUvQJAG8ybNwPTH1vlZ+Izjhe6gB5+axF8",
                    "BzzBC5vrDstldPKzN7lraD+JYCWNKMndMbNWoWTP/IyOrqzmVOSZKjShCQJAbzuE",
                    "C2QxaqeqpmnxkKWuCrPfZl8NdryvpPolK/jQG8qTrHlgibD4nCjYE7nWGkrD6Xs/",
                    "hNgXC56YSnDaTRQJFQJAD5GFACv9QgcMZhy1hza0yGDMSQ0WR8/y3CJhi3DPOuAf",
                    "MetGM1kLQR8bDFrl7yEs+Nufk8QTsE5ngZ7dGFgmuA==",
                ],
                "X509Cert": [
                    "MIIBxDCCAS2gAwIBAQIBATANBgkqhkiG9w0BAQUFADAAMB4XDTAzMDMzMTEwNTMw",
                    "NVoXDTA5MDMyOTEwNTMwNVowUDEkMCIGCSqGSIb3DQEJARYVaW9jbGllbnRAMTky",
                    "LjE2OC4xLjIwMREwDwYDVQQLEwhzZWN1cml0eTEVMBMGA1UEAxMMMTkyLjE2OC4x",
                    "LjIwMIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDD285BGY+FHhfpRvcqupN8",
                    "X2lPwUNq4G7k5kit5cyuQLfN0+eQI+VFZdtfJhCZC54dEIvNgA4I7563pRUD0S9r",
                    "mN6kh/M0GgrKZjYNO+CvvG2dts26MGK0eUQaSsvDf9phEA+0mSv9dsUrdyBTJBn4",
                    "mXvApekYHt+mNLfCVLkM1QIDAQABMA0GCSqGSIb3DQEBBQUAA4GBAA5pWiXJOHCJ",
                    "P6kHcBITJuwv94zZ0dbHby1ljUfG/8z3Fmr8JRUcTuTtgVYH9M0O9QujIR8YLWSV",
                    "0GeD3nkLRn0+ezam0CW0dF/Ph5vNXFP4a0DSEVv7T0G21VFmbUV3xrVeaXARFuLa",
                    "AtqRoSyBMajd3g0WNXDCgGEH7LvzJ5EP",
                ],
            },
            "192.168.1.26": {
                "Subject": {
                    ...
                    "organizationalUnitName": "security",
                    "emailAddress": "ioclient@192.168.1.26",
                },
                "RsaPKey": [
                    "MIICXQIBAAKBgQC5ILRHC3wFoqG9Egb96N3iGEnVrgvQikHyXYc/jFMUgB79rVJp",
                    "hY1MziGkSjSyc3RFMshkjHlMlARMPCNtomIikqAQaO4Eke2SYWyaOBoTdkeOy+yZ",
                    "t/POpoGp3nRmKGed6NNcdMd5BO01GiatUb7X/Se3Yyvmj5UcEmv/hZQGFwIDAQAB",
                    "AoGBALdR5FMp0zE9X437iQLsErQuOwcmpzplfnJDHYfXK/nz+TxY4m/tuQNiZ7vp",
                    "Y4+Gdo+Dfx7aX89uD2dycd7B2wwTziBGIEjhusD8gtralVjhBDjCowSOkezWTeY+",
                    "2h40NB4e1uypOZb0PXWvAL/l9xN7NBGioq9zmShT5c+FFO8RAkEA4k3QSaT1ScGI",
                    "5II5JolvPnv6yS+0dCQTn1SC2ABWbH75NDUHMGAdNIf1sqhaLSQnY9GuXhb8XqX6",
                    "UUhoypUHzwJBANFrqnuEuTNKR0HVD31/2trPYLfZL6/9RUsR4mlvxPb0tX+T5LVL",
                    "5he43zbura/lZqNxt0ZVeD03LanPN7bvZzkCQQCMAToIJa6+x6YKQOpchhA1pvwb",
                    "NZE9fQhKvT0JpwPQsak4/EmLSxsmYarGsdLANKrN3W4ztaLCZ4r6eIKkOhkPAkBz",
                    "ke4wYitucbRnUTRONuvJSx599x6JCcVey0zekO7qtlsfP7e8kVk2iDCu+QLjCj8d",
                    "Pdk9uFc1uSi7CH8ftniJAkBLNYF0kfGC+CaTuyfnIwiBZ/tjmm4UvHfwtlaZHJYc",
                    "QIjimBxVA7mujrv3xIBTiDMdxUhq9YIaKIEdlveaTwPK",
                ],
                "X509Cert": [
                    "MIIBxDCCAS2gAwIBAQIBATANBgkqhkiG9w0BAQUFADAAMB4XDTAzMDMzMTEwNTQx",
                    "NloXDTA5MDMyOTEwNTQxNlowUDEkMCIGCSqGSIb3DQEJARYVaW9jbGllbnRAMTky",
                    ...
                    "GEnVrgvQikHyXYc/jFMUgB79rVJphY1MziGkSjSyc3RFMshkjHlMlARMPCNtomIi",
                    "kqAQaO4Eke2SYWyaOBoTdkeOy+yZt/POpoGp3nRmKGed6NNcdMd5BO01GiatUb7X",
                    "/Se3Yyvmj5UcEmv/hZQGFwIDAQABMA0GCSqGSIb3DQEBBQUAA4GBAMPd5SXzpwZ+",
                    "40SdOv/PeQ5cjieDm6QjndWE/T8nG2I5h6YRWbZPohsCClQjrTyZCMXwcUiCimuJ",
                    "BaMigI/YqP5THVv58Gu8DpoVZppz7uhUNS5hsuV9lxZUh1bRkUtL6n0qSTEdM34I",
                    "NJBJKGlf0skULg9BT4LJYTPGWJ0KosUl",
                ],
            },
        }
    ...
    def PKeyFromPemRepr(self, ObjName=None, PemPKey=None):
        ...
        self.CurrentObj["RsaPubKey"] = M2Crypto.RSA.new_pub_key(
            self.CurrentObj["RsaPKey"].pub()
        )

    def CertFromPemRepr(self, ObjName=None, PemCert=None):
        if ObjName in self.PemMap:
            UsedPemCert = (
                self.KeyEnv["X509Cert"][0]
                + "\n"
    ...
    def ObjNameFromPemCert(self, PemCert=None):
        ...
        if ObjName not in self.ObjMap:
            ...
            self.CurrentObj["EvpPubKey"] = self.CurrentObj["X509Cert"].get_pubkey()
            self.CurrentObj["RsaPubKey"] = M2Crypto.RSA.rsa_from_pkey(
                self.CurrentObj["EvpPubKey"]
            )
        else:
            self.CurrentObj = self.ObjMap[ObjName]
        return ObjName
    ...
    def CreatePKey(self):
        ...
        self.CurrentObj["RsaPKey"] = M2Crypto.RSA.gen_key(
            RsaKeyParams["KeyLength"],
            RsaKeyParams["PubExponent"],
            RsaKeyParams["keygen_callback"],
        )
    ...
    def CreateCert(self, SignEvpPKey=None):
        ...
        X509Cert.set_not_before(
            int(time.time() - self.Params["NotBefore"])
        )  # 1 year in the past
        X509Cert.set_not_after(
            int(time.time() + self.Params["NotAfter"])
    ...
    def ClientInit(self, ObjName=None):
        ...
        NoncePrivEncrypted = re.sub(
            "\012",
            "",
            base64.encodestring(
                self.NonceEncryptPrivate(
                    NonceDecrypted, RsaPKey=self.ServerObj["RsaPKey"]
                )
            ),
        )
        PemCert = re.sub(
        ...
        InitString = re.sub(
            "\012", "", base64.encodestring("%s:%s" % (NoncePrivEncrypted, PemCert))
        )
    ...
    def ClientInitVerify(self, InitString):
        ...
        if Result != 1:
            raise AuthError(
                'verification of X509 cert with Certification Authority "CA" failed with code %d - abort!'
                % (Result)
            )
        ClientObjName = self.ObjNameFromPemCert(PemCert=PemCert)
        try:
            NonceDecrypted = self.NonceDecryptPublic(
                NoncePrivEncrypted, RsaPubKey=self.CurrentObj["RsaPubKey"]
            )
        except:
    ...
    def ServerInit(self, ClientObjName, ClientNonce):
        ...
        NonceServer = re.sub(
            ...
            "",
            base64.encodestring(
                self.NonceEncryptPublic(
                    NonceDecrypted, RsaPubKey=self.CurrentObj["RsaPubKey"]
                )
            ),
        )
        NonceBounce = re.sub(
            ...
            base64.encodestring(
                self.NonceEncryptPublic(
                    ClientNonce, RsaPubKey=self.CurrentObj["RsaPubKey"]
                )
            ),
        )
        PemServerCert = re.sub(
            "\012",
            "",
            base64.encodestring(
                self.KeyEnv["X509Cert"][0]
        ...
        InitString = re.sub(
            "\012",
            "",
            base64.encodestring("%s:%s:%s" % (NonceServer, NonceBounce, PemServerCert)),
        )
        return (NonceDecrypted, InitString)
    ...
    def ServerInitVerify(self, InitString, ObjName=None):
        ...
        try:
            NonceDecrypted = self.NonceDecryptPrivate(
                NoncePubServer, RsaPKey=self.ServerObj["RsaPKey"]
            )
        except:
            return False
        ...
        try:
            NonceBounceDecrypted = self.NonceDecryptPrivate(
                NoncePubBounce, RsaPKey=self.CurrentObj["RsaPKey"]
            )
        except:
            return False
    ...
    def ReplyInit(self, ReplyObjName, ReplyBounce):
        ...
        NoncePubInit = re.sub(
            ...
            base64.encodestring(
                self.NonceEncryptPublic(
                    NonceDecrypted, RsaPubKey=self.ObjMap[ReplyObjName]["RsaPubKey"]
                )
            ),
        )
        NoncePubBounce = re.sub(
            "\012",
            "",
            base64.encodestring(
                self.NonceEncryptPublic(
                    ReplyBounce, RsaPubKey=self.ObjMap[ReplyObjName]["RsaPubKey"]
                )
            ),
        )
        ReplyString = re.sub(
            "\012", "", base64.encodestring("%s:%s" % (NoncePubInit, NoncePubBounce))
        )
    ...
    def ReplyVerify(self, ReplyString):
        ...
        try:
            NoncePubInit = base64.decodestring(
                NoncePubInit
            )  # new Nonce from Remote, encrypted with own publickey
        except base64.binascii.Error as msg:
            raise base64.binascii.Error(msg)
        try:
            NoncePubBounce = base64.decodestring(
                NoncePubBounce
            )  # bounced Nonce from Remote, encrypted with Remote privatekey
        except base64.binascii.Error as msg:
            raise base64.binascii.Error(msg)

        # verify Nonce from Remote encrypted with my own publickey
        try:
            NonceRemote = self.NonceDecryptPrivate(
                NoncePubInit, RsaPKey=self.ServerObj["RsaPKey"]
            )
        except:
        ...
        try:
            NonceBounced = self.NonceDecryptPrivate(
                NoncePubBounce, RsaPKey=self.ServerObj["RsaPKey"]
            )
        except:
            raise AuthError("wrong public key for encoding nonce - abort!")
