...
def asn1_object_create(tag: int, data: bytes, length: int, sn: str, ln: str) -> C.ASN1_Object: ...
...
def engine_load_private_key(engine: C.ENGINE, key_id: str,
                            ui_method: Any,
                            callback_data: Any) -> Optional[C.EVP_PKEY]: ...
def engine_load_public_key(engine: C.ENGINE, key_id: str,
                           ui_method: Any,
                           callback_data: Any) -> Optional[C.EVP_PKEY]: ...
...
def provider_generate_rsa_key_pair(bits: int, exponent: int, provider: Optional[C.OSSL_PROVIDER]) -> Optional[C.EVP_PKEY]: ...
def provider_generate_ec_key_pair(curve_name: str, provider: Optional[C.OSSL_PROVIDER]) -> Optional[C.EVP_PKEY]: ...
