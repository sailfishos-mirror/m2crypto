...
def provider_load(name: str) -> Optional[C.OSSL_PROVIDER]: ...
def provider_load_key(uri: str) -> Optional[C.EVP_PKEY]: ...
def provider_load_certificate(uri: str) -> Optional[C.X509]: ...
def provider_unload(provider: C.OSSL_PROVIDER) -> None: ...
def provider_generate_rsa_key_pair(
    bits: int, exponent: int, provider: Optional[C.OSSL_PROVIDER]
) -> Optional[C.EVP_PKEY]: ...
def provider_generate_ec_key_pair(
    curve_name: str, provider: Optional[C.OSSL_PROVIDER]
) -> Optional[C.EVP_PKEY]: ...
