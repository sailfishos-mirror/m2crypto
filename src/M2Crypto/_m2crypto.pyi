...
STACK_OF = List[Any]
STACK_OF_X509 = List[C.X509]
STACK_OF_SSL_CIPHER = List[C.SSL_CIPHER]
STACK_OF_X509_EXTENSION = List[C.X509_EXTENSION]
...
def asn1_string_set(s: C.ASN1_String, data: bytes, length: int) -> int: ...
...
def bn_rand_range(range_bn: C.BIGNUM) -> int: ...
...
def dh_set_pg(dh: C.DH, p: C.BIGNUM, g: C.BIGNUM) -> int: ...
...
def dsa_read_params(bio: C.BIO) -> Optional[C.DSA]: ...
def dsa_read_pub_key(bio: C.BIO) -> Optional[C.DSA]: ...
def dsa_set_pqg(dsa: C.DSA, p: C.BIGNUM, q: C.BIGNUM, g: C.BIGNUM) -> int: ...
def dsa_set_pub(dsa: C.DSA, pub_key: C.BIGNUM) -> int: ...
...
def sk_ssl_cipher_num(stack: STACK_OF_SSL_CIPHER) -> int: ...
def sk_ssl_cipher_value(stack: STACK_OF_SSL_CIPHER, idx: int) -> C.SSL_CIPHER: ...
def ssl_accept(ssl: C.SSL, timeout: float = -1) -> int: ...
...
def ssl_connect(ssl: C.SSL, timeout: float = -1) -> int: ...
...
def ssl_get_ciphers(ssl: C.SSL) -> STACK_OF_SSL_CIPHER: ...
...
def ssl_get_peer_cert_chain(ssl: C.SSL) -> Optional[STACK_OF_X509]: ...
def ssl_get_peer_certificate(ssl: C.SSL) -> Optional[C.X509]: ...
...
def ssl_read(ssl: C.SSL, num: int, timeout: float = -1) -> Optional[bytes]: ...
...
def ssl_write(ssl: C.SSL, data: bytes, timeout: float = -1) -> int: ...
def tlsv1_method() -> C.SSL_METHOD: ...

# --- X509 ---
def d2i_x509(bio: C.BIO) -> Optional[C.X509]: ...
def d2i_x509_req(bio: C.BIO) -> Optional[C.X509_REQ]: ...
def get_der_encoding_stack(stack: STACK_OF_X509) -> bytes: ...
def i2d_x509_bio(bio: C.BIO, x509: C.X509) -> int: ...
def i2d_x509_req_bio(bio: C.BIO, req: C.X509_REQ) -> int: ...
def i2d_x509(x: C.X509) -> bytes: ...
def make_stack_from_der_sequence(der: bytes) -> STACK_OF_X509: ...
def sk_x509_extension_free(stack: STACK_OF_X509_EXTENSION) -> None: ...
def sk_x509_extension_new_null() -> STACK_OF_X509_EXTENSION: ...
def sk_x509_extension_num(stack: STACK_OF_X509_EXTENSION) -> int: ...
def sk_x509_extension_pop(stack: STACK_OF_X509_EXTENSION) -> C.X509_EXTENSION: ...
def sk_x509_extension_push(
    stack: STACK_OF_X509_EXTENSION, ext: C.X509_EXTENSION
) -> int: ...
def sk_x509_extension_value(
    stack: STACK_OF_X509_EXTENSION, idx: int
) -> C.X509_EXTENSION: ...
def sk_x509_free(stack: STACK_OF_X509) -> None: ...
def sk_x509_new_null() -> STACK_OF_X509: ...
def sk_x509_num(stack: STACK_OF_X509) -> int: ...
def sk_x509_pop(stack: STACK_OF_X509) -> Optional[C.X509]: ...
def sk_x509_push(stack: STACK_OF_X509, cert: C.X509) -> int: ...
def sk_x509_value(stack: STACK_OF_X509, idx: int) -> C.X509: ...
...
def x509_req_add_extensions(req: C.X509_REQ, exts: STACK_OF_X509_EXTENSION) -> int: ...
...
def x509_store_ctx_get1_chain(ctx: C.X509_STORE_CTX) -> STACK_OF_X509: ...
...
def pkcs7_verify0(
    p7: C.PKCS7, certs: STACK_OF_X509, store: C.X509_STORE, flags: int
) -> bytes: ...
def pkcs7_verify1(
    p7: C.PKCS7, certs: STACK_OF_X509, store: C.X509_STORE, data: C.BIO, flags: int
) -> bytes: ...
def pkcs7_encrypt(
    certs: STACK_OF_X509, data: C.BIO, cipher: C.EVP_CIPHER, flags: int
) -> Optional[C.PKCS7]: ...
...
def smime_write_pkcs7(bio: C.BIO, p7: C.PKCS7, data: C.BIO, flags: int) -> int: ...
...
def pkcs7_get0_signers(
    p7: C.PKCS7, certs: STACK_OF_X509, flags: int
) -> STACK_OF_X509: ...
